          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="https://maps.app.goo.gl/qAsDmKJqeoJWBWub6?g_st=aw" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Shop No. 5, Meena Bazaar, Somvanshiya Gyati Samaj, Near Police Station, Bhayandar (West), Thane - 401101</a>
              </li>
            </ul>
          </div>
        </div>
